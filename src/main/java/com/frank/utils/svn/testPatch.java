...
public class testPatch {
	public static String patchFile="F:/patch.txt";//更新某个版本
    
    public static String projectPath="E:/work_mtOrder/tiyan_mtorder";//项目文件夹路径  
    ...
    public static String desPath="E:/realese";//补丁文件包存放路径  
    ...
    public static void copyFiles(List<String> list){  
        ...
        for(String fullFileName:list){  
            if(fullFileName.indexOf("src/main/java")!=-1){//对源文件目录下的文件处理  
                ...
                String desFileName=fullFileName.replaceAll("src/main/webapp","");  
                fullFileName=staticPath+"/"+fullFileName;//将要复制的文件全路径  
